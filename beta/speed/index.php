...
<p>Вы находитесь в экспериментальной части клавиатурного тренажера "Клавобоярин". Режим "Speed" предназначен для уже продвинутых пользователей машинописи, развивает скорость и безошибочность набора текста.</p>
<hr/>
